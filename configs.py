...
STREAM_LOGS = environ.get('STREAM_LOGS','-1001626107740')
...
class Config(object):
	...
	BOT_TOKEN = os.environ.get("BOT_TOKEN","7129593614:AAF1UwRL2ZBONLoysOhPQv-AJQ_zNw13ysI")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "@File_Press_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1001569815531))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "6133440326"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://abdulmk184:abdulmk184@cluster0.fv4ffn1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001954276464")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001626107740")
